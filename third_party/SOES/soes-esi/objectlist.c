...
const _objd SDO2000[] = {
    {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RW, acName2000_00, 2, NULL},
    {0x01, DTYPE_UNSIGNED16, 16, ATYPE_RW, acName2000_01, 0,
     &Obj.max_motor_velocities[0]},
    {0x02, DTYPE_UNSIGNED16, 16, ATYPE_RW, acName2000_02, 0,
     &Obj.max_motor_velocities[1]},
};
const _objd SDO6001[] = {
    {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName6001_00, 2, NULL},
    {0x01, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6001_01, 0,
     &Obj.can0_motor_positions[0]},
    {0x02, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6001_02, 0,
     &Obj.can0_motor_positions[1]},
};
const _objd SDO6002[] = {
    {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName6002_00, 2, NULL},
    {0x01, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6002_01, 0,
     &Obj.can0_motor_velocities[0]},
    {0x02, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6002_02, 0,
     &Obj.can0_motor_velocities[1]},
};
const _objd SDO6003[] = {
    {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName6003_00, 2, NULL},
    {0x01, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6003_01, 0,
     &Obj.can0_motor_currents[0]},
    {0x02, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_TXPDO, acName6003_02, 0,
     &Obj.can0_motor_currents[1]},
};
const _objd SDO6004[] = {
    {0x00, DTYPE_UNSIGNED8, 8, ATYPE_RO, acName6004_00, 2, NULL},
    {0x01, DTYPE_UNSIGNED8, 8, ATYPE_RO | ATYPE_TXPDO, acName6004_01, 0,
     &Obj.can0_motor_temperatures[0]},
    {0x02, DTYPE_UNSIGNED8, 8, ATYPE_RO | ATYPE_TXPDO, acName6004_02, 0,
     &Obj.can0_motor_temperatures[1]},
};
const _objd SDO7000[] = {
...
const _objd SDO7001[] = {
    ...
    {0x01, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_RXPDO, acName7001_01, 0,
     &Obj.can0_motor_commands[0]},
    {0x02, DTYPE_INTEGER16, 16, ATYPE_RO | ATYPE_RXPDO, acName7001_02, 0,
     &Obj.can0_motor_commands[1]},
};
