...
/* photogate relative */
#define PHOTOGATE1_Pin GPIO_PIN_3
#define PHOTOGATE1_GPIO_Port GPIOA
#define PHOTOGATE_1_GPIO_CLK_ENABLE __HAL_RCC_GPIOA_CLK_ENABLE()
#define PHOTOGATE_1_GPIO_CLK_DISABLE __HAL_RCC_GPIOA_CLK_DISABLE()

#define PHOTOGATE2_Pin GPIO_PIN_2
#define PHOTOGATE2_GPIO_Port GPIOD
#define PHOTOGATE_2_GPIO_CLK_ENABLE __HAL_RCC_GPIOD_CLK_ENABLE()
#define PHOTOGATE_2_GPIO_CLK_DISABLE __HAL_RCC_GPIOD_CLK_DISABLE()

#define PHOTOGATE3_Pin GPIO_PIN_11
#define PHOTOGATE3_GPIO_Port GPIOC
#define PHOTOGATE_3_GPIO_CLK_ENABLE __HAL_RCC_GPIOC_CLK_ENABLE()
#define PHOTOGATE_3_GPIO_CLK_DISABLE __HAL_RCC_GPIOC_CLK_DISABLE()
